...
Modify the program so that it uses the recommended spelling conventions, constant 
...
public class messy {
	public static void main(String[] args)
	{
		...
		System.out.println("This program calculates your pace given a time and
         distance traveled.");
...
public class Messy {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Your pace is " + pace+ " minutes per mile");
